...
create table recipe (cook_time integer, prep_time integer, servings integer, id bigint not null auto_increment, notes_id bigint, description varchar(255), difficulty enum ('EASY','HARD','KIND_OF_HARD','MODERATE'), source varchar(255), url varchar(255), directions tinytext, image tinyblob, primary key (id)) engine=InnoDB;
